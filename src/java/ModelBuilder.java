...
public class ModelBuilder {
    ...
    public static Model buildModel(String projName, String projURL, boolean isCross, ArrayList<String> projects, ArrayList<Metric> metrics, MyClassifier classifier) {

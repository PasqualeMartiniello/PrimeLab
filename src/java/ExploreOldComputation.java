 ...
 * @author fabiano
 */
@WebServlet(urlPatterns = {"/ExploreOldComputation"})
public class ExploreOldComputation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = sc.getRequestDispatcher("/exploreOldComputation.jsp");
